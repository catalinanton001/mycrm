...
@section('content')
    ...
    {!! Form::model($all_task, ['method' => 'PUT', 'route' => ['admin.all_tasks.update', $all_task->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('in_analysis', 1, old('in_analysis', old('in_analysis')), []) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('in_process', 1, old('in_process', old('in_process')), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('done', 0) !!}
                    {!! Form::checkbox('done', 1, old('done', old('done')), []) !!}
                    <p class="help-block"></p>
                    @if($errors->has('done'))
                        <p class="help-block">
                            {{ $errors->first('done') }}
